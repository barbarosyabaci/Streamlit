...
def Calculating_pivot(df_sel):
    ...
    agg_list = {'Latitude': ['min', 'max'], 'Longitude': ['min', 'max'], "Session_No": 'mean', "Test_type": agg_str, 'Distance': sum, 'CombinedColumn': agg_str, 'Serving Cell RS SINR (dB)': ['mean', 'min', 'max'], 'Serving Cell RSRP (dBm)': ['mean', 'min', 'max'], 'Serving Cell RSRQ (dB)': ['mean', 'min', 'max'], 'HTTP_URL': agg_str, 'HTTP_Download_Average_Throughput': 'mean', 'HTTP_Download_Service_Average_Throughput': 'mean', 'HTTP_Download_Session_Failure_Ratio': 'mean',
        'HTTP_Download_Session_Success_Ratio': 'mean', 'HTTP_Outcome': agg_str, "HTTP_Download_Data_Transfer_Failure_Ratio_Method_A": 'mean', "HTTP_Download_Data_Transfer_Success_Ratio_Method_A": 'mean', "HTTP_Download_Data_Transfer_Time_sec_Method_A": 'mean', "HTTP_Download_IP_Service_Access_Failure_Ratio_Method_A": 'mean', "HTTP_Download_IP_Service_Setup_Success_Ratio_Method_A": 'mean', "HTTP_Download_IP_Service_Setup_Time_sec_Method_A": 'mean',
        "HTTP_Download_Mean_Data_Rate_kbps_Method_A": 'mean', "HTTP_Download_Transfer_Start_Delay_Method_A": 'mean', "HTTP_Download_Data_Transfer_Failure_Ratio_Method_B": 'mean', "HTTP_Download_Data_Transfer_Success_Ratio_Method_B": 'mean', "HTTP_Download_Data_Transfer_Time_sec_Method_B": 'mean', "HTTP_Download_IP_Service_Access_Failure_Ratio_Method_B": 'mean', "HTTP_Download_IP_Service_Setup_Success_Ratio_Method_B": 'mean', "HTTP_Download_IP_Service_Setup_Time_sec_Method_B": 'mean',
        "HTTP_Download_Mean_Data_Rate_kbps_Method_B": 'mean', "HTTP_Upload_Average_Throughput": 'mean', "HTTP_Upload_Service_Average_Throughput": 'mean', "HTTP_Upload_Service_Transfer_Time": 'mean', "HTTP_Upload_Session_Failure_Ratio": 'mean', "HTTP_Upload_Session_Success_Ratio": 'mean', "HTTP_Upload_Data_Transfer_Failure_Ratio_Method_A": 'mean', "HTTP_Upload_Data_Transfer_Success_Ratio_Method_A": 'mean', "HTTP_Upload_Data_Transfer_Time_sec_Method_A": 'mean',
        "HTTP_Upload_IP_Service_Access_Failure_Ratio_Method_A": 'mean', "HTTP_Upload_IP_Service_Setup_Success_Ratio_Method_A": 'mean', "HTTP_Upload_IP_Service_Setup_Time_sec_Method_A": 'mean', "HTTP_Upload_Mean_Data_Rate_kbps_Method_A": 'mean', "Streaming_URL": agg_str, "Streaming_Outcome_Type": agg_str, "Aborted_by_User": 'mean', "Streaming_Average_Session_Resolution": 'mean', "Streaming_Average_Throughput": 'mean', "Streaming_Completion_Rate": 'mean', "Streaming_Duration": 'mean',
        "Streaming_HD_Resolution": agg_str, "Streaming_HD_Resolution_Ratio": 'mean', "Streaming_Impairment_Free": agg_str, "Streaming_Impairment_Free_Video_Session_Ratio": 'mean', "Streaming_Maximum_Duration_Of_Video_Session_Interruptions": 'mean', "Streaming_Number_Of_Video_Session_Interruptions": 'mean', "Streaming_Player_Size_kB": 'mean', "Streaming_Reproduction_Cutoff_Ratio": 'mean', "Streaming_Reproduction_Start_Delay_sec": 'mean', "Streaming_Reproduction_Start_Failure_Ratio": 'mean',
...
"FTP_Upload_Bearer",
"FTP_Upload_Outcome",
"UDP_Download_Error_Cause",
"UDP_Upload_Error_Cause",
"DNS_Client",
"DNS_Domain_Name",
...
def merge_type_table(df_result):
    import pandas as pd
    Grouping_All_Url = [
"8.8.8.8",
